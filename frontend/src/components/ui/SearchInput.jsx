...
const SearchInput = ({ value, onChange, placeholder = 'Search...', debounceMs = 300 }) => {
 ...
 className="w-full pl-9 pr-9 py-2 text-sm rounded-xl border border-slate-700 bg-slate-900 text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/40 focus:border-amber-500 transition"
 />
 {internal && (
 <button
 onClick={handleClear}
