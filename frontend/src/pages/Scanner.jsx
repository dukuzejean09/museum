  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold">{t('scanner.identifyTitle')}</h1>
        <p className="text-slate-600 mt-2">{t('scanner.identifySubtitle')}</p>
      </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex justify-center gap-4 mt-4">
            ...
            <button
              ...
              className="w-16 h-16 rounded-full bg-slate-200 text-slate-600 flex items-center justify-center hover:bg-slate-300 transition"
            >
              <Square size={24} />
            </button>
          </div>
            ...
            >
              <div className="flex gap-4 p-4">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-bold group-hover:text-amber-600 transition">{result.exhibition.title?.en || result.exhibition.title}</h4>
                  <p className="text-sm text-slate-600 line-clamp-2">{result.exhibition.shortDescription?.en || ''}</p>
                  ...
                  <p className="mt-2 text-sm text-slate-500">{t('scanner.viewFull')} →</p>
                </div>
              </div>
            </Link>
          )}
