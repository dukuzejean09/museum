...
const AdminStories = () => {
 ...
 <th className="text-left px-6 py-3 text-sm font-medium text-slate-400">Exhibition</th>
 <th className="text-left px-6 py-3 text-sm font-medium text-slate-400">Status</th>
 <th className="text-left px-6 py-3 text-sm font-medium text-slate-400">Created</th>
 ...
 return (
 <tr key={story._id} className="hover:bg-slate-800">
 <td className="px-6 py-4">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-lg bg-purple-900/20 flex items-center justify-center text-purple-600">
 <BookOpen size={18} />
 </div>
