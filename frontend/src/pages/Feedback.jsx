...
const Feedback = () => {
 ...
 <div className="text-center bg-white rounded-2xl p-10 shadow-sm border border-slate-200 max-w-md">
 <CheckCircle size={64} className="text-green-500 mx-auto mb-4" />
 <h2 className="text-2xl font-bold mb-2">{t('survey.thanks')}</h2>
 <p className="text-slate-600 mb-6">{t('survey.thanksMsg')}</p>
 ...
 <Link to="/map" className="inline-flex items-center justify-center gap-2 border border-amber-600 text-amber-700 px-6 py-2 rounded-xl hover:bg-amber-50 transition font-semibold">
 ...
 <h1 className="text-3xl font-bold">{t('nav.feedback')}</h1>
 <p className="text-slate-600 mt-2">{t('survey.subtitle')}</p>
 </div>
 ...
 {/* Survey Tab */}
 {tab === 'survey' && (
 <form onSubmit={handleSurveySubmit} className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 space-y-6">
 <div>
 <label className="block text-sm font-medium mb-1">{t('survey.name')}</label>
 <input type="text" name="visitorName" value={surveyForm.visitorName} onChange={handleSurveyChange} className={inputClass} />
 </div>

 <div>
 <label className="block text-sm font-medium mb-2">{t('survey.overall')} *</label>
 <StarRating value={surveyForm.overallRating} onChange={(val) => setSurveyForm(prev => ({ ...prev, overallRating: val }))} />
 </div>

 <div>
 <label className="block text-sm font-medium mb-1">{t('survey.favorite')}</label>
 ...
 <div>
 <label className="block text-sm font-medium mb-1">{t('survey.duration')}</label>
 ...
 <label htmlFor="recommend" className="">{t('survey.recommend')}</label>
 </div>

 <div>
 <label className="block text-sm font-medium mb-1">{t('survey.comments')}</label>
 ...
 <form onSubmit={handleMsgSubmit} className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 space-y-4">
