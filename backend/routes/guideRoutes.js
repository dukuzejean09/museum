...
adminRouter.post('/', protect, requireRole('admin'), upload.single('image'), validateUpload, createGuide);
adminRouter.put('/:id', protect, requireRole('admin'), upload.single('image'), validateUpload, updateGuide);
...
guideRouter.put('/profile', protect, requireRole('guide', 'admin'), upload.single('image'), validateUpload, updateMyProfile);
